package ch.example.gradetracker.ui.schoolyear
...
fun SchoolYearScreen(
    ...
    val subjects by repository.getSubjectsForSchoolYear(schoolYearId!!)
        .collectAsState(initial = emptyList())
    val grades by repository.getGradesForSchoolYear(schoolYearId)
        .collectAsState(initial = emptyList())
                    ...
                    DropdownMenu(
                        ...
                        Column(verticalArrangement = Arrangement.SpaceEvenly) {
                            TextButton(
                                ...
                                Text(
                                    "Neueste", color = if (subjectSort == SubjectSort.NEWEST) {
                                        selectedColor
                                    } else {
                                        unselectedColor
                                    }
                            ...
                            TextButton(
                                ...
                                Text(
                                    "Älteste", color = if (subjectSort == SubjectSort.OLDEST) {
                                        selectedColor
                                    } else {
                                        unselectedColor
                                    }
                            ...
                            TextButton(
                                ...
                                Text(
                                    "Name", color = if (subjectSort == SubjectSort.NAME) {
                                        selectedColor
                                    } else {
                                        unselectedColor
                                    }
                            ...
                            TextButton(
                                ...
                                Text(
                                    "Bester Schnitt",
                                    color = if (subjectSort == SubjectSort.VALUE_DESC) {
                                        selectedColor
                                    } else {
                                        unselectedColor
                                    }
