package ch.example.gradetracker.ui.home
...
fun SchoolYearCard(
    ...
    val grades by repository.getGradesForSchoolYear(schoolYear.id)
        .collectAsState(initial = emptyList())
    val subjects by repository.getSubjectsForSchoolYear(schoolYear.id)
        .collectAsState(initial = emptyList())
                ...
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Row(
                            ...
                            Icon(
                                imageVector = if (Calculator.getPointsForSchoolYear(
                                        grades = grades,
                                        subjects = subjects
                                    ) == null || Calculator.getPointsForSchoolYear(
                                        grades = grades,
                                        subjects = subjects
                                    )!! >= 0
                                ) {
