                            ...
                            ElevatedCard(
                                ...
                                Box {
                                    Column(
                                        ...
                                        Text(LocalDateTime.parse(absence.date).dayOfWeek.getDisplayName(
                                        ...
                                        Text(
                                            formatTime(absence.timeSlot.startTime) + " - " + formatTime(absence.timeSlot.endTime)
                                        )
                                    }
       ...
       if (showAbsenceCard) {
           ModalBottomSheet(
               ...
               Box(modifier = Modifier.fillMaxSize()){
                   AbsenceInformationCard(absence = showingAbsence)
               }
           }
       }
    }
