package ch.example.gradetracker.ui.subject
                    ...
                    DropdownMenu(
                        ...
                        Column(verticalArrangement = Arrangement.SpaceEvenly) {
                            TextButton(
                                ...
                                Text(
                                    "Neueste", color = if (gradeSort == GradeSort.NEWEST) {
                                        selectedColor
                                    } else {
                                        unselectedColor
                                    }
                            ...
                            TextButton(
                                ...
                                Text(
                                    "Älteste", color = if (gradeSort == GradeSort.OLDEST) {
                                        selectedColor
                                    } else {
                                        unselectedColor
                                    }
                            ...
                            TextButton(
                                ...
                                Text(
                                    "Name", color = if (gradeSort == GradeSort.NAME) {
                                        selectedColor
                                    } else {
                                        unselectedColor
                                    }
                            ...
                            TextButton(
                                ...
                                Text(
                                    "Beste Note", color = if (gradeSort == GradeSort.VALUE_DESC) {
                                        selectedColor
                                    } else {
                                        unselectedColor
                                    }
